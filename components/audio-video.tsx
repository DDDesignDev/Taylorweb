export function AudioVideo() {
  return (
    <section id="audiovideo" className="py-24 md:py-32 bg-muted relative shadow-2xl">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4">Performances</h2>
