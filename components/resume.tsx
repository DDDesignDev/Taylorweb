...
export function Resume() {
  return (
    <section id="resume" className="py-24 md:py-32 bg-background relative shadow-2xl">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4">Resume & Credits</h2>
